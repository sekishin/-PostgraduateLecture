...
//========================関数宣言=========================
void player(Board *brd, Piece wh, bool *pass, THands t_hands);        // プレイヤの処理
Board brd_init(void);                       // 盤面の初期化
void brd_output(Board brd, Piece c, THands *t_hands);                 // 盤面の出力
...
//========================プレイヤ==========================
void player(Board *brd, Piece wh, bool *pass, THands t_hands) {
    //-- 宣言
    Hand hand;
    hand.color = wh;
...
//========================盤面出力=========================
void brd_output(Board brd, Piece c, THands *t_hands) {
    //-- 宣言
    int x, y;    // 反復変数
    Board tmp_b;
